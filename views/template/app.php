...
<body class="bg-slate-900">
    ...
    <header class="">
        <div>
            <nav class="flex justify-between p-5">
                ...
                <a href="/playlist" class="text-xl text-slate-100">Playlists</a>
            </nav>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const playlistLink = document.querySelector('a[href="/playlist"]');
            ...
            playlistLink.classList.remove('bg-emerald-300/15', 'px-2', 'py-1', 'rounded-xl');

            // Adiciona as classes ao link correspondente à URL atual
            if (currentPath === '/' || currentPath === '/new-chord' || currentPath === '/chord') {
                homeLink.classList.add('bg-emerald-300/15', 'px-2', 'py-1', 'rounded-xl');
            } else if (currentPath === '/playlist' || currentPath === '/play-chord' || currentPath === '/save-playlist') {
                playlistLink.classList.add('bg-emerald-300/15', 'px-2', 'py-1', 'rounded-xl');
            }
        });
    </script>
</body>
